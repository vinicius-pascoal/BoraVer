  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-md border-b border-primary/30 bg-gradient-to-r from-darker/95 via-dark/90 to-darker/95 shadow-lg shadow-primary/10">
      <div className="w-full max-w-8xl mx-auto px-3 sm:px-4 md:px-6">
        <div className="py-2 sm:py-3 md:py-4 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-8">
          {/* Logo */}
          <div className="flex-shrink-0 group cursor-pointer transition-transform duration-300 hover:scale-105">
            <div className="relative">
              ...
              <Image
                ...
                width={220}
                height={60}
                className="h-12 w-auto sm:h-14 md:h-16 relative"
                priority
              />
            </div>
          </div>
          ...
          <div className="flex-1 text-center sm:text-right hidden sm:block">
            <div className="space-y-1">
              <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-purple-400 to-pink-400 bg-clip-text text-transparent leading-tight font-heading">
                Descubra o que assistir
              </h1>
              <p className="text-xs sm:text-sm md:text-base text-gray-400 font-body leading-relaxed max-w-md ml-auto mt-1 sm:mt-2">
